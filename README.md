...
1. I started by reviewing the code inside the main file 'Program.cs':
	...
	- Removed infinite loop possibility while finding the first position for a character (if the grid has 1 or less available spaces it would never fit 2 characters);
